...
| **AI-based Profile Summary** | The "Profile" section is automatically generated by OpenAI from the uploaded CV. | ![AI-based Profile Summary](static/media/documentation/ai-summary.png) |
...
| **Bulk Upload** | Allow multiple files to be uploaded at one in candidate modal | ![Bulk Upload](static/media/documentation/bulk-upload.png) |
